                ...
                if (player.EndingUnlocked == true && player.CurrentRoom.Name == "Living Room") // intiates game ending
                {
                    ...
                    if (player.Inventory.Contains("collar")) // enables route 1 ending
                    {
                        ...
                        if (player.Inventory.Contains("milk")) // good ending
                        {
                            ...
                            Graphics.Type(player.fastMode, "You got the good ending! How boring...", "green");
                        ...
                        else // bad ending
                        {
                            ...
                            Graphics.Type(player.fastMode, "You got the ok ending... Meh.", "green");
                            Graphics.Type(player.fastMode, "Press any key to quit.", "green");
                            Console.ReadKey();
                            Environment.Exit(0);                                                  
                        }
                    ...
                    Graphics.Type(player.fastMode, "GAME OVER. AHAHAHAHA", "red", 200, 50);      
                    Graphics.Type(player.fastMode, "Press any key to quit.", "green");
                    Console.ReadKey();             
                    Environment.Exit(0);                                                  
                    }
