...
namespace DungeonGame
{
    ...
    {
        private int kitchenState = 1; // Represents the state or visit count of the kitchen.
        ...
        public string GetDescription()
        {
            ...
            {
                case 1:
                    description = "You come back into the kitchen to find some cat-nip..." +
                                  "\nYou're not sure what it's for but you just decide to pick it up.";
                    break;
                case 2:
                    description = "When entering the room again you find an open can of Feline Feast on the marble counter." +
                                  "\nYou wonder if there's someone else in the dungeon with you.";
                    break;
                case 3:
                    description = "After going back into the kitchen for more clues you find a piece of paper that says a few words on it." +
                                  "\nUpon further inspection you see it has the Hello Cat showtimes for today..." +
                                  "\nIt makes you want to sit down and watch the show.";
                    break;
                case 4:
                    description = "Upon your scramble for hints in the kitchen you see a cat collar that says 'Kitty' on it..." +
                                  "\nYou decide to pick it up.";
                    break;
                case 5:
                    description = "You hope to find another clue in the kitchen, one that would help more this time. " +
                    ...
                    break;
                default:
                    description = "The kitchen seems unfamiliar. Are you lost?";
                    break;
            }
